...
public class CardProvider<T extends CardProvider> extends Observable {
    ...
    public T setGender(@NonNull final String gender)
    {
        mGender=gender;
        notifyDataSetChanged();
        return (T) this;
    ...
    public T setAge(@NonNull final String age)
    {
        mAge=age;
        notifyDataSetChanged();
        return (T) this;
    ...
    public void render(@NonNull final View view, @NonNull final Card card) {
        ...
        ////////
        final TextView gender=findViewById(view,R.id.gender,TextView.class);
        gender.setText(getGender());
        gender.setTextColor(getSubtitleColor());
        gender.setGravity(getSubtitleGravity());


        final TextView age=findViewById(view,R.id.age,TextView.class);
        age.setText(getAge());
        //////////////
